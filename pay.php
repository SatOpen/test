...
<div class="container">
    <div class="row">
        <div class="col-md-6 col-md-offset-3">
            ...
            <form class="form-horizontal" role="form" method="post" action="pay.php" onsubmit="if(document.getElementById('agree').checked) { return true; } else { alert('Please indicate that you have read and agree to the TOS and Validate Payment after to paid.'); return false; }">
                ...
                <div class="form-group" id="clineDiv">
                    ...
                    <div class="col-sm-5">
                        <input type="text" class="form-control" id="cline" name="cline" placeholder="EX: 'username password'">
